...
<body style="background-image:url('assets/images/lelang.jpg');" id="page-top">
    ...
    <div class="wrapper">
            ...
            <div id="content ">
                ...
                <nav class="navbar navbar-expand navbar-light bg-light topbar mb-4 static-top shadow ">
                    ...
                    <div class="col-md-8">
                        <form action="" class="search-top-form" method="post">
