...
class Data_lelang extends CI_Controller
{
	...
	public function edit($id_lelang)
	{
	  ...
	  $data['tb_lelang'] = $this->Lelang_model->edit_lelang($where, 'tb_lelang')->row_array();
  
	  $this->load->view('templates_admin/header');
	  $this->load->view('templates_admin/sidebar');
	  $this->load->view('admin/data_lelangH/edit', $data);
	  $this->load->view('templates_admin/footer');
	}
	...
	public function update()
	{
	  ...
	  $this->lelang_model->update_data($where, $data, 'tb_lelang');
    ...
    public function insert()
    {
        ...
        $this->lelang_model->insert_data($data);
        $this->session->set_flashdata(
			'message',
